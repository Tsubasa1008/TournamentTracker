...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // id, team name, lsit of ids separated by pipe
            // 3, Tim's Team, 1|3|5
        ...
        public static List<MatchupEntryModel> ConvertToMatchEntryModels(this List<string> lines)
        {
        ...
        public static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(string input)
        {
            ...
            output = matchingEntries.ConvertToMatchEntryModels();
        ...
        {
            List<MatchupEntryModel> entries = GlobalConfig.MatchupEntryFile.FullFilePath().LoadFile().ConvertToMatchEntryModels();
